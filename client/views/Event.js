...
import {ReadAllEvents} from '../api/EventEndpoint';
...
const Event = () => {
	...
	const fetchEventList = useCallback(async () => {
		await ReadAllEvents(setEventList, searchQuery);
	}, [searchQuery]);
	...
	await eventListVisible();

	console.log("ongoingVisible: ", ongoingVisible);
	console.log("pendingVisible: ", pendingVisible);
	console.log("finishedVisible: ", finishedVisible);
	console.log(" ");
	}, [fetchEventList]);
