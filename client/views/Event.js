...
const Event = () => {
	...
	const fetchPendingEventList = () => {
		axios.post(global.URL+'/events/searchEventStatus',
	...
	const fetchOngoingEventList = () => {
		axios.post(global.URL+'/events/searchEventStatus',
		JSON.stringify('ongoing'))
		.then(res => {
			setOngoingEventList(res.data);
		})
		.catch(err => {
			console.log(err);
		})
	...
	// FINISHED
	const [FinishedEventList, setFinishedEventList] = useState([]);
	const fetchFinishedEventList = () => {
		axios.post(global.URL+'/events/searchEventStatus',
		JSON.stringify('finished'))
		.then(res => {
			setFinishedEventList(res.data);
		})
		.catch(err => {
			console.log(err);
		})
