...
type Playlist struct {
	...
	Authorization_id string             `bson:"authorization_id,omitempty" json:"authorization_id,omitempty"` // TODO Automatic creation when create
	Songs            []Song             `bson:"songs,omitempty" json:"songs,omitempty"` // TODO special routes
	Picture          string             `bson:"picture,omitempty" json:"picture,omitempty"` // TODO by default
}
